...
@WebServlet("/visualizarprodutos") // Anotação para registrar o servlet
public class visualizarprodutos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("exibirProduto.jsp").forward(request, response);  // A URL depende da estrutura de pastas
